    ...
    <nav class="navbar navbar--header navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <a class="navbar-brand" href="#">
                <img src="<?= ($logo) ? $logo : '/assets/admin/img/logo-1.png' ?>" alt="logo" width="100px" class="img-fluid logo">
            </a>

            <div class="d-flex ms-auto">
                <div class="btn-group">
                    <div type="button" class="dropdown-toggle text-white" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                        <img class="rounded-circle" src="/assets/img/user.png" alt="foto" width="40px">
                    </div>
